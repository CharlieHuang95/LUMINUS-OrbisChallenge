...
class UnitMachine:
    ...
    def get_next_position(self, count, world, unit, defenders, state):
        final_target = None
...
class PlayerAI:
    ...
    def decide_nest_positions(self, nest):
        ...
        while q:
            ...
            if distance > min(self.start_world.get_width(), self.start_world.get_height()) / 3:
                continue
            ...
            if not self.has_better_adjacent_nest(location) and self.can_be_nest(location, hypothetical_nests):
    ...
    def do_move(self, world, friendly_units, enemy_units):
        ...
        for unit in friendly_units:
            ...
            next_location = self.units_map[unit].get_next_position(self.count, world, unit, self.defenders, self.state)
